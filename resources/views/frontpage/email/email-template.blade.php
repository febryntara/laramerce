                                                                                        ...
                                                                                        <td align='left'>
                                                                                            <a href='#'>
                                                                                                <img align='left'
                                                                                                    ...
                                                                                                    height='33'
                                                                                                    padding='5px' b
                                                                                                    src="{{ asset('image/catalog/urban.png') }}"
                                                                                                    width='120' />
                                                                                            </a>
                                                                                        </td>
                                                                                        <td align='right'
                                    ...
                                    <tr>
                                        <td align='left'
                                            ...
                                            <table border='0' cellpadding='0' cellspacing='0'
                                                ...
                                                width='100%'>
                                                <tr>
                                                    <th style='text-align: left; border-bottom: 1px solid #cccccc; color: #4d4d4d; font-weight: 700; padding-bottom: 5px;'
                                                        width='50%'>
                                                        Item
                                                    </th>
                                                    <th style='text-align: right; border-bottom: 1px solid #cccccc; color: #4d4d4d; font-weight: 700; padding-bottom: 5px;'
                                                        width='15%'>
                                                        Qty
                                                    </th>
                                                    <th style='text-align: right; border-bottom: 1px solid #cccccc; color: #4d4d4d; font-weight: 700; padding-bottom: 5px; '
                                                    ...
                                                    <tr
                                                        ...
                                                        <td width='50%'>
                                                            <table cellpadding='0' cellspacing='0'
                                                                style="font-size:14px; line-height:19px; font-family: 'Oxygen', 'Helvetica Neue', helvetica, sans-serif;"
                                                                width='100%'>
                                                                <tbody>
                                                                    <tr>
                                                                        <td
                                                                            style="text-align:left; font-size:14px; line-height:19px; font-family: ' oxygen', 'helvetica neue', helvetica, sans-serif; color: #777777;">
                                                                            <span
                                                        ...
                                                        <td style='text-align:right; ' width='10%'>
                                                            {{ ch_currency($item->quantity * $item->price) }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </table>
                                            ...
                                            <table border='0' cellpadding='0' cellspacing='0'
                                                ...
                                                <tr
                                                    ...
                                                    <td
                                                        ...
                                                        <br /> --}}
                                                        <span
                                                            style='display: inline-block;font-weight: bold; color: #4d4d4d'>
                                                            Total
                                                        </span>
                                                    </td>
