                    ...
                    <aside class="col-md-3 col-sm-4 col-xs-12 content-aside left_column " id="column-left">
                        <div class="module blog-category titleLine">
                            ...
                            <div class="modcontent">
                                <ul class="list-group ">
                                    <li class="list-group-item"> <a href="blog-page.html"class="group-item active">Our
                                            Blog</a></li>
                                    <li class="list-group-item"><a href="blog-page.html" class="group-item">Demo Category
                                            2</a></li>
                                    <li class="list-group-item"><a href="blog-page.html" class="group-item">Demo Category
                                            3</a></li>
                                    <li class="list-group-item"><a href="blog-page.html" class="group-item">Demo Category
                    ...
                    <div id="content" class="col-md-9 col-sm-8">
                        ...
                        <div class="blog-category clearfix">
                                            ...
                                            <div class="article-image">
                                                <div>
                                                    <a class="popup-gallery" href="image/catalog/blog/4.jpg">
                                                        <img src="image/catalog/blog/4.jpg"
                                        ...
                                        <div class="itemBlogContent clearfix ">
                                            <div class="blog-content">
                                                <div class="article-title font-title">
                                                    <h4><a href="blog-detail.html">Duis autem vel eum irure sed diam
                                                            nonumy</a></h4>
                                                </div>
                                                <div class="blog-meta"> <span class="author"><i
                                                            class="fa fa-user"></i><span>Post by </span>Tuannn</span><span
                                                        class="comment_count"><i class="fa fa-comment-o"></i><a
                                                            href="#">2 Comments</a></span>
                                                </div>
                                                <p class="article-description">Lorem ipsum dolor amet, sadips cing elitr,
                                                    sed diam nonumy eirmod. Lore...</p>
                                                <div class="readmore"> <a class="btn-readmore font-title"
                                                        href="blog-detail.html"><i class="fa fa-caret-right"></i>Read
                                                        More</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="blog-item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="blog-item-inner clearfix">
                                        ...
                                        <div class="itemBlogContent clearfix ">
                                            <div class="blog-content">
                                                <div class="article-title font-title">
                                                    <h4><a href="blog-detail.html">Biten demons lector in autem sadips
                                                            vulp</a></h4>
                                                </div>
                                                <div class="blog-meta"> <span class="author"><i
                                                            class="fa fa-user"></i><span>Post by </span>Tuannn</span><span
                                                        class="comment_count"><i class="fa fa-comment-o"></i><a
                                                            href="#">0 Comment</a></span>
                                                </div>
                                                <p class="article-description">Lorem ipsum dolor amet, sadips cing elitr,
                                                    sed diam nonumy eirmod. Lore...</p>
                                                <div class="readmore"> <a class="btn-readmore font-title"
                                ...
                                <div class="blog-item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="blog-item-inner clearfix">
                                            ...
                                            <div class="article-image">
                                                <div>
                                                    <a class="popup-gallery" href="image/catalog/blog/7.jpg">
                                                        <img src="image/catalog/blog/7.jpg"
                                        ...
                                        <div class="itemBlogContent clearfix ">
                                            <div class="blog-content">
                                                <div class="article-title font-title">
                                                    <h4><a href="blog-detail.html">Duis autem Biten demons lector in
                                                            henderit in vulp</a></h4>
                                                </div>
                                                <div class="blog-meta"> <span class="author"><i
                                                            class="fa fa-user"></i><span>Post by </span>Tuann</span> <span
                                                        class="comment_count"><i class="fa fa-comment-o"></i><a
                                                            href="#">0 Comment</a></span>
                                                </div>
                                                <p class="article-description">Lorem ipsum dolor amet, sadips cing elitr,
                                ...
                                <div class="blog-item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="blog-item-inner clearfix">
                                            ...
                                            <div class="article-image">
                                                <div>
                                                    <a class="popup-gallery" href="image/catalog/blog/6.jpg">
                                                        <img src="image/catalog/blog/6.jpg"
                                        ...
                                        <div class="itemBlogContent clearfix ">
                                            <div class="blog-content">
                                                <div class="article-title font-title">
                                                    <h4><a href="blog-detail.html">Enim ad minim veniam justo duo dolores
                                                            et ea</a></h4>
                                                </div>
                                                <div class="blog-meta"> <span class="author"><i
                                                            class="fa fa-user"></i><span>Post by </span>Tuannn</span> <span
                                ...
                                <div class="blog-item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="blog-item-inner clearfix">
                                        ...
                                        <div class="itemBlogContent clearfix ">
                                            <div class="blog-content">
                                                <div class="article-title font-title">
                                                    <h4><a href="blog-detail.html">Kire tuma feugiat veniam justo duo
                                                            dolores minim</a></h4>
                                                </div>
                                                <div class="blog-meta"> <span class="author"><i
                                                            class="fa fa-user"></i><span>Post by </span>Tuannn</span><span
                                ...
                                <div class="blog-item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="blog-item-inner clearfix">
                                            ...
                                            <div class="article-image">
                                                <div>
                                                    <a class="popup-gallery" href="image/catalog/blog/3.jpg">
                                                        <img src="image/catalog/blog/3.jpg"
                                        ...
                                        <div class="itemBlogContent clearfix ">
                                            <div class="blog-content">
                                                <div class="article-title font-title">
                                                    <h4><a href="blog-detail.html">Lorem ipsum dolor sadips sit amet
                                                            autem</a></h4>
                                                </div>
                                                <div class="blog-meta"> <span class="author"><i
                                                            class="fa fa-user"></i><span>Post by </span>Tuannn</span> <span
                                ...
                                <div class="blog-item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="blog-item-inner clearfix">
                                            ...
                                            <div class="article-image">
                                                <div>
                                                    <a class="popup-gallery" href="image/catalog/blog/10.jpg">
                                                        <img src="image/catalog/blog/10.jpg"
                                        ...
                                        <div class="itemBlogContent clearfix ">
                                            <div class="blog-content">
                                                <div class="article-title font-title">
                                                    <h4><a href="blog-detail.html">Commodo laoreet semper tincidun sit</a>
                                                    </h4>
                                                </div>
                                                <div class="blog-meta"> <span class="author"><i
                                                            class="fa fa-user"></i><span>Post by </span>Tuannn</span><span
                                ...
                                <div class="blog-item col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="blog-item-inner clearfix">
                                        ...
                                        <div class="itemBlogContent clearfix ">
                                            <div class="blog-content">
                                                <div class="article-title font-title">
                                                    <h4><a href="blog-detail.html">Kire tuma demons vel eum iriure
                                                            dolor</a></h4>
                                                </div>
                                                <div class="blog-meta"> <span class="author"><i
                                                            class="fa fa-user"></i><span>Post by </span>Tuannn</span><span
                                                        class="comment_count"><i class="fa fa-comment-o"></i><a
                                                            href="#">6 Comments</a></span>
                                                </div>
                                                <p class="article-description">Lorem ipsum dolor amet, sadips cing elitr,
                                                    sed diam nonumy eirmod. Lore...</p>
                                                <div class="readmore"> <a class="btn-readmore font-title"
                            ...
                            <div class="product-filter product-filter-bottom filters-panel clearfix">
                                <div class="blog-listitem-bottom row">
                                    <p class="col-md-5 col-sm-5">Item 01 - 09 of 27 total</p>
                                    <ul class="pagination col-md-7 col-sm-7 text-right">
