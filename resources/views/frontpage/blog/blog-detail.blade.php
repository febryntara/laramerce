                    ...
                    <aside class="col-md-3 col-sm-4 col-xs-12 content-aside left_column " id="column-left">
                        <div class="module blog-category titleLine">
                            ...
                            <div class="modcontent">
                                <ul class="list-group ">
                                    <li class="list-group-item"> <a href="{{ route('blog') }}"class="group-item active">Our
                                            Blog</a></li>
                                    <li class="list-group-item"><a href="{{ route('blog') }}" class="group-item">Demo
                                            Category 2</a></li>
                                    <li class="list-group-item"><a href="{{ route('blog') }}" class="group-item">Demo
                                            Category 3</a></li>
                                    <li class="list-group-item"><a href="{{ route('blog') }}" class="group-item">Demo
                    ...
                    <div id="content" class="col-md-9 col-sm-8">
                        <div class="article-info">
                            ...
                            <div class="form-group">
                                <a href="image/catalog/blog/4.jpg" class="image-popup"><img
                                        src="image/catalog/blog/4.jpg" alt="Kire tuma demonstraverunt lector"></a>
                            </div>

                            <div class="article-description">
                                <p>Morbi tempus, non ullamcorper euismod, erat odio suscipit purus, nec ornare lacus turpis
                                    ...
                                    laoreet. Morbi tempor massa sit amet purus lobortis, non porta tellus dignissim. </p>
                                <p>Proin dictum justo a nisl pellentesque egestas.Nulla commodo euismod nisi ac bibendum.
                                    ...
                                    lacinia. Nullam posuere neque at neque dictum interdum</p>
                                <p> Mauris cursus in mi vel dignissim. Morbi mollis elit ipsum, a feugiat lectus gravida
                                    ...
                                    neque at neque dictum interdum</p>
                            </div>
                                        ...
                                        <div id="comments" class="blog-comment-info">
                                            ...
                                            <div class="comment-left contacts-form row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <br>
                                                    <input type="text" name="captcha" style="" value=""
                                                        class="form-control">
                                                    <br>
                                                    <div class="form-group">
