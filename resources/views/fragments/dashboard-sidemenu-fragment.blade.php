<nav class="side-nav">
    ...
    <ul>
        ...
        <li>
            <a href="{{ route('manage_brand.all') }}" class="side-menu {{ Request::is('dashboard/brands') ? 'side-menu--active' : '' }}">
        ...
        @can('isUser')
        <li>
            <a href="{{ route('manage_cart.all') }}" class="side-menu {{ Request::is('dashboard/carts') ? 'side-menu--active' : '' }}">
