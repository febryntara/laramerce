        ...
        <div class="search-result">
            <div class="search-result__content">
                ...
                <a href="" class="flex items-center mt-2">
                    ...
                    <div class="ml-auto w-48 truncate text-slate-500 text-xs text-right">PC &amp;
                        Laptop
                    </div>
                </a>
                <a href="" class="flex items-center mt-2">
        ...
        <div class="notification-content pt-2 dropdown-menu">
            <div class="notification-content__box dropdown-content">
                ...
                <div class="cursor-pointer relative flex items-center ">
                    ...
                    <div class="ml-2 overflow-hidden">
                        <div class="flex items-center">
                            ...
                            <div class="text-xs text-slate-400 ml-auto whitespace-nowrap">05:09 AM
                            </div>
                        </div>
                ...
                <div class="cursor-pointer relative flex items-center mt-5">
                    ...
                    <div class="ml-2 overflow-hidden">
                        <div class="flex items-center">
                            <a href="javascript:;" class="font-medium truncate mr-5">Angelina
                                Jolie</a>
                            <div class="text-xs text-slate-400 ml-auto whitespace-nowrap">03:20 PM
                            </div>
                        </div>
                ...
                <div class="cursor-pointer relative flex items-center mt-5">
                    ...
                    <div class="ml-2 overflow-hidden">
                        <div class="flex items-center">
                            ...
                            <div class="text-xs text-slate-400 ml-auto whitespace-nowrap">06:05 AM
                            </div>
                        </div>
                        <div class="w-full truncate text-slate-500 mt-0.5">It is a long established
                            fact
    ...
    <div class="intro-x dropdown w-8 h-8">
        ...
        <div class="dropdown-menu w-56">
            <ul class="dropdown-content bg-primary text-white">
                ...
                <li>
                    <a href="{{ route('profile.detail',['user'=>auth()->user()]) }}" class="dropdown-item hover:bg-white/5"> <i data-lucide="user"
